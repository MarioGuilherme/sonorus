                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(width: sizeOfLastLine, height: 10, color: Colors.white)
                        ]
                      ),
                      const SizedBox(height: 10),
                      if (withMedias) ...[
              ...
              children: [
                Expanded(
                  child: Container(
                    width: 90,
                    height: 40,
                    decoration: const BoxDecoration(borderRadius: BorderRadius.only(bottomLeft: Radius.circular(10)), color: Colors.white)
                  )
                ),
                if (withTablature) ...[
                  const SizedBox(width: 2.5),
                  Container(width: 64, height: 40, decoration: const BoxDecoration(color: Colors.white))
                ],
                 const SizedBox(width: 2.5),
                Expanded(
                  child: Container(
                    width: 90,
                    height: 40,
                    decoration: const BoxDecoration(borderRadius: BorderRadius.only(bottomRight: Radius.circular(10)), color: Colors.white)
                  )
                )
              ]
            )
