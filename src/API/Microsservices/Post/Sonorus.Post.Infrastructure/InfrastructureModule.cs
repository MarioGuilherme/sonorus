...
using Sonorus.Post.Infrastructure.Persistence.Repositories;
using Sonorus.Post.Infrastructure.Services;
using System.Text;
...
public static class InfrastructureModule {
    ...
    private static IServiceCollection AddMessageBroker(this IServiceCollection services, IConfiguration configuration) {
        ...
        services.AddSingleton(serviceBusClient.CreateProcessor("deleted-users_microservice-post"));
