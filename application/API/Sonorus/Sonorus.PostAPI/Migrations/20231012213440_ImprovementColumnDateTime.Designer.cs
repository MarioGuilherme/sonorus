...
namespace Sonorus.PostAPI.Migrations
{
    ...
    [Migration("20231012213440_ImprovementColumnDateTime")]
    partial class ImprovementColumnDateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sonorus.PostAPI.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CommentAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 12, 18, 34, 40, 314, DateTimeKind.Local).AddTicks(8943));
            ...
            modelBuilder.Entity("Sonorus.PostAPI.Data.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("PostedAt")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 12, 18, 34, 40, 314, DateTimeKind.Local).AddTicks(8547));
