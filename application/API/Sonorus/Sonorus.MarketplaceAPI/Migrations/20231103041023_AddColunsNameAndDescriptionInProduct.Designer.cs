...
namespace Sonorus.MarketplaceAPI.Migrations
{
    ...
    [Migration("20231103041023_AddColunsNameAndDescriptionInProduct")]
    partial class AddColunsNameAndDescriptionInProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sonorus.MarketplaceAPI.Data.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("AnnouncedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 3, 1, 10, 23, 390, DateTimeKind.Local).AddTicks(3761));
